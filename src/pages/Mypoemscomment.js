            ...
            return (
              <div key={key} className="comment">
                ...
                <div>
                    ...
                    <button style={{width:'50px',backgroundColor:'#FF9999',cursor:'pointer'}} onClick={() => deleteComment(comment.id)}>Hide</button>
